...
To compile all slides in a lecture in 4:3 (relying on the LaTeX file in `style/` to be updated in the lecture) and copies them to `slides-pdf`:
...
This does not copy the `lecture_sl.pdf` file to `slides-pdf` yet, but `make all-nomargin` would.
