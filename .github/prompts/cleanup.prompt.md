...
---
Your goal is to cleanup the source code (macros, environments, styles, ...) of the provided LaTeX source file. Note that the compiled PDF should not change drastically, wording should stay the **exact** same. However, do correct simple typos.
